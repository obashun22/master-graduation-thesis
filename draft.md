...
- ローイング競技の現状
  ...
  - （衝突検知について）人の意識に依らない新たな衝突防止策が求められている

### 1.2 研究目的

- 本研究の目的
  - 低コストなローイング競技向け衝突防止システムを開発し競技の安全性を向上すること
  - システムを実現する上での課題を明らかにし、後の研究に示唆を与えること
  <!--
  低コスト => Rowcusとの比較
  ローイング競技向け => SmartAISとの比較
  ### 目的に含まれる要素
  - 安全性の向上
  - 低コスト
  - ローイング競技向け
...
- 本研究の貢献
  - ...
  - ソースコードの公開
  - 既存システムの課題を明らかにし、その課題を解決するためのシステムの提案を行った
...
- 評価の観点
  - システムの機能および性能について述べた後、安全性・コスト・使用性について評価し、研究目的に対する達成度を考察する
